...
import { HotPathsList } from './HotPathsList';
import { ActivityChart } from './ActivityChart';
import { LoadingPage, LoadingCard } from './Loading';
...
export const RepositoryDashboard = ({ refreshKey }: RepositoryDashboardProps) => {
  ...
  if (overview.error && !overview.data) {
    return (
      <div className="min-h-[40vh] flex items-center justify-center">
        <ErrorDisplay
          message={`Failed to load repository overview: ${overview.error.message}`}
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <Card title="Complexity Hotspots" subtitle="Files ranked by complexity score">
          {complexity.loading && !complexity.data ? (
            ...
            <ComplexityHeatmap data={complexity.data!} onFileClick={setSelectedFile} />
          )}
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        >
          {hotPaths.loading && !hotPaths.data ? (
            ...
            <HotPathsList hotPaths={hotPaths.data!.hotPaths} limit={5} onHotPathClick={setSelectedHotPath} />
          )}
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        ...
        >
          {commits.loading && !commits.data ? (
            ...
            <RecentCommits commits={commits.data!.commits} onCommitClick={setSelectedCommit} />
          )}
        </Card>
      </div>
      ...
      >
        {ownership.loading && !ownership.data ? (
          ...
          <OwnershipPanel data={ownership.data!} onFileClick={setSelectedOwnershipFile} />
        )}
      </Card>

      <FileDetailsModal isOpen={!!selectedFile} onClose={() => setSelectedFile(null)} file={selectedFile} />
      ...
      <SignalDetailsModal isOpen={!!selectedSignal} onClose={() => setSelectedSignal(null)} signal={selectedSignal} />
